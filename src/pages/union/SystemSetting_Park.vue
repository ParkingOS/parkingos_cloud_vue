    ...
    <section class="right-wrapper-size shop-table-wrapper" id="scrollBarDom">
        <div class="shop-custom-operation">
            <header class="shop-custom-header">
                <p style="float: left">系统设置<span style="margin: 2px">-</span>停车场</p>
            ...
            <div class="shop-custom-console">
                <el-form :inline="true" :model="searchFormData" class="shop-custom-form-search">
                    <div class="advanced-options" v-show="isShow">
                        <el-form-item label="车场秘钥" class="clear-style">
        ...
        data() {
            return {
                ...
                tableitems: [
                            ...
                            render: (h, params) => {
                                return h('div', [
                                    h('ElButton', {
                                        ...
                                        style: {
                                            display:this.showCustomizeEdit?'':'none'
                                        },
                                        on: {
                                            click: (e) => {
                                    ...
                                    h('ElButton', {
                                        ...
                                        on: {
                                            click: (e) => {
                                                window.event? window.event.cancelBubble = true : e.stopPropagation();
                                                this.$router.push({path: '/systemSetting_Park_Staff?shop_id='+params.row.id});
                                            }
                                        }
                                    }, '设置'),
                                    h('ElButton', {
                    ...
                    //             columnType:'render',
                    //             render: (h, params) => {
                    //                 let str = common.dateformat(params.row.beat_time);
                    //                 return h('div', [
                    //                     h('span', str)
                    //                 ]);
                    //             }
