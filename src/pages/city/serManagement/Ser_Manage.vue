...
<script>
    ...
    export default {
                                    ...
                                    h('ElButton', {
                                        ...
                                        on: {
                                            click: (e) => {
                                                ...
                                                this.$set(this.addForm,'parentId',this.addForm.parentId+'');
        ...
        methods: {
                ...
                this.$refs.addForm.validate((valid) => {
                    if(valid){
                        ...
                        if(that.addType == 'add'){
                            ...
                            newForm.parent_id = addForm.parentId;
            ...
            getQuery(){
                let _this = this;
                _this.$axios.get(path+'/getdata/getServersByUnion?unionid='+sessionStorage.getItem('unionid'))
                    .then((retSList)=>{
                        _this.unionList = retSList.data;
                        _this.unionList.unshift({
                            value_no:0,
                            value_name:'无服务商'
                        })
                    })
