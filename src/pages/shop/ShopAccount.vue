<template>
  <section style="padding: 10px;">
    ...
    <el-row :gutter="15" style="margin-top:28px" >
      ...
      <el-col :span="12" >
        <el-card class="box-card" style="height:180px">
          <div>
            ...
            <el-button-group style="width:100%">
                  <el-button style="display:inline;width:40%;margin-top:-4px" @click="handleCodeReduce()" type="primary" >扫码减免</el-button>
                  <el-button style="display:inline;width:40%;margin-top:-4px" @click="handleCarReduce()" type="primary" >车牌减免</el-button>
                  <el-button style="display:inline;width:20%;margin-top:-4px" @click="handleReduceExport()" type="primary" >导出</el-button>
            </el-button-group>
      </el-col>
       ...
       <el-col :span="12" >
           ...
           <el-button-group style="width:100%">
                     <el-button style="display:inline;width:40%;margin-top:-4px" @click="handleFreeCodeReduce()" type="primary" :disabled='disable' >扫码全免</el-button>
                     <el-button style="display:inline;width:40%;margin-top:-4px" @click="handleFreeCarReduce()" type="primary" :disabled='disable'>车牌全免</el-button>
                     <el-button style="display:inline;width:20%;margin-top:-4px" @click="handleFreeReduceExport()" type="primary" :disabled='disable'>导出</el-button>
           </el-button-group>
       </el-col>
    ...
    <!--</el-form>-->
        ...
        <el-dialog title="导出减免" center=true  :visible.sync="exportVisible" :close-on-click-modal="false" size="tiny"  @close="closeExport">
            <div style="margin-left:15%" >
                <el-form :model="exportModel" ref="exportModel">
                    <el-form-item>
                        <el-input v-model="exportModel.reduce" style="width:35%" placeholder="输入单张优惠时长"></el-input>
                        <el-input v-model="carNumReduce.number" style="width:35%" placeholder="输入优惠券数量"></el-input>
                        <el-button @click="useTicketByCarNumber" type="primary" size ="small" style="height: 38.5px;margin-top: -2px;">导 出</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </el-dialog>
...
//               console.log(vm.code+"1111111111111111111111111111111")
    ...
    closeExport(){
        this.exportModel.reduce=''
        this.exportModel.number=''
    },
    closeFreeCar(){
