<template>
    <section>
        ...
        <el-dialog title="厂商设置-员工管理" width="60%" :visible.sync="showSetPark">
...
<script>
    ...
    //import employeeManage from './SystemSetting_EmployeeManage'
    ...
    export default {
        ...
        data() {
            return {
                ...
                addFormRules: {
                    ...
                    ukey: [
                        {required: true, message: '请填写厂商秘钥', trigger: 'blur'}
                    ],
                    union_id: [
        ...
        methods: {
            showSetting: function (row) {
                ...
                this.getTableData({});
                let _this = this;
                sessionStorage.setItem('cityid', row.id);
                axios.all([common.getCityEmployeeRole()])
