    ...
    export default {
        ...
        data() {
            return {
                ...
                actReceivable:0,
                amountReceivable:0,
                queryapi: '/prepayuse/query',
                orderfield:'id',
                fieldsstr: 'id__trade_no__card_id__ctime__amount_receivable__amount_pay__name__pay_type__car_number__user_id__limit_time__resume__start_time',
                tableitems: [
                    {
                        hasSubs: false,
                        subs: [{
