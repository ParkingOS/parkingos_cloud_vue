    ...
    export default {
        ...
        data() {
            return {
                ...
                orderfield:'id',
                fieldsstr: 'id__card_id__pid__name__car_number__p_lot__ctime__b_time__e_time__total__add_money__mobile__car_type_id__limit_day_type__remark',
                queryapi: '/prepaycard/query',
                exportapi: '/prepaycard/exportExcel',
                addapi: '/prepaycard/add',
                editapi: '/prepaycard/edit',
                delapi: '/prepaycard/delete',
                renewapi:'/prepaycard/renewproduct',
                delForm:{},
                delVisible:false,
                loading: false,
                resetloading: false,
            ...
            setAuthorityFn(){
                ...
                if (user) {
                    ...
                    for (var item of user.authlist) {
                        if (AUTH_ID.prepay_card == item.auth_id) {
