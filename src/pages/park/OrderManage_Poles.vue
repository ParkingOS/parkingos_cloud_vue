    ...
    export default {
        ...
        methods: {
            showImgDialog: function (index, row) {
                this.imgdialog_url = path + this.imgapi + '?liftrodid=' + encodeURI(encodeURI(row.liftrod_id)) + '&comid=' + sessionStorage.getItem('comid') + '&token=' + sessionStorage.getItem('token');
